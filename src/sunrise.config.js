...
if (getEnv("REACT_APP_LOCAL_SUNRISE_CONFIG")) {
  localConfig = require(process.env.REACT_APP_LOCAL_SUNRISE_CONFIG).default;
}
const config = {
  ct: {
    auth: {
      ...
      projectKey: getEnv("REACT_APP_CT_PROJECT_KEY") || "sunrise-spa",
      credentials: {
        clientId:
          getEnv("REACT_APP_CT_CLIENT_ID") || "1mnlpBq-fHCCkAzmSXxNBB37",
        clientSecret:
